...
// TODO: Move to a separate `features/dashboard/constants.ts` or fetch from API
const stats = [
  {
...
const activities = [
  ...
  {
    text: 'Disease detected: Early Blight',
    time: 'Yesterday',
    status: 'Completed' as const,
  },
  {
      ...
      <div className="mx-auto max-w-[1440px]">
        <div className="mb-7 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="flex items-center gap-2 text-sm text-[#68756B]">
            <CalendarDays className="size-4 text-[#132A1D]" /> Friday, September
            18, 2026
          </div>
        </div>
          ...
          {stats.map((stat) => (
            <article key={stat.label} className={`${cardClass} p-5 shadow-sm`}>
              <div className="flex items-start justify-between">
                ...
                <span className="text-xs font-medium text-[#21633A]">
                  {stat.note}
                </span>
              </div>
              <p className="mt-6 text-3xl font-semibold text-[#132A1D]">
                {stat.value}
              </p>
            ...
            <div className="flex items-center justify-between border-b border-[#D4DAC8] px-5 py-5 sm:px-6">
              <div>
                ...
                <p className="mt-1 text-xs text-[#68756B]">
                  Latest updates across your farms
                </p>
              </div>
              <Button
                type="button"
              ...
              {activities.map((activity) => (
                ...
                >
                  <div className="min-w-0">
                    <p className="text-sm font-medium text-[#1F3527]">
                      {activity.text}
                    </p>
                    <p className="mt-1 text-xs text-[#68756B]">
                      {activity.time}
          ...
          <section>
            ...
            <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-1">
              ...
              >
                ...
                <h4 className="mt-7 font-semibold">
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <ArrowUpRight className="size-5 text-[#132A1D] transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
                </div>
                <h4 className="mt-7 font-semibold text-[#132A1D]">
                  Check Plant Health
                </h4>
